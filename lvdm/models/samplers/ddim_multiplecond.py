...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      unconditional_guidance_scale=1., unconditional_conditioning=None, verbose=True,precision=None,fs=None,guidance_rescale=0.0,rotation=90.0,
                      **kwargs):
        ...
        for i, step in enumerate(iterator):
            ...
            if rotation != 0.0:
                img = torch.roll(shifts=int(img.size(-1)*(rotation/360)), input=img, dims=-1)
